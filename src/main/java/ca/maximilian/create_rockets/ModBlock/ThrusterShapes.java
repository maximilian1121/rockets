...
public final class ThrusterShapes {
    ...
    public static final VoxelShaper RAPTOR_3_EXTENSION = shape(15, 14, 0, 16, 16, 15) // (0 part: 30-32 -> 14-16)
    ...
    public static final VoxelShaper SATURN_V_F1_BASE = shape(0, 0, 0, 16, 5, 16) // (0)
    ...
    public static final VoxelShaper SATURN_V_F1_EXTENSION = shape(1, 14, 0, 16, 16, 1) // (1)
    ...
    public static final class Builder {
        ...
        public Builder add(final double x1, final double y1, final double z1,
                           final double x2, final double y2, final double z2) {
            this.shape = Shapes.or(this.shape, Block.box(x1, y1, z1, x2, y2, z2));
            return this;
        }

        public Builder erase(final double x1, final double y1, final double z1,
                             final double x2, final double y2, final double z2) {
        ...
        private VoxelShaper build(final BiFunction<VoxelShape, Direction, VoxelShaper> factory, final Direction direction) {
