...
import ca.maximilian.create.rockets.content.blocks.thruster.ThrusterType;
...
public final class CreateRocketsBlocks {
    ...
    public static final DeferredBlock<ThrusterBlock> RAPTOR_3 =
            BLOCKS.register(
                    "raptor_3",
                    () -> new ThrusterBlock(defaultMetalProperties(), ThrusterType.RAPTOR_3));

    public static final DeferredBlock<ThrusterBlock> SATURN_V_F1 =
            BLOCKS.register(
                    "saturn_v_f1",
    ...
    private static BlockBehaviour.Properties defaultMetalProperties() {
        return BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(3.0f);
    }
}
